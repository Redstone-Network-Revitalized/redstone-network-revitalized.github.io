...
{
localStorage.clear()
alert("Fusion Emergency Reset Activated")
...
document.addEventListener("keydown", function(event) {
  if (event.shiftKey && event.ctrlKey && event.code == "KeyI") {
    event.preventDefault();
    sendNotification("OS","Developer Console Toggled! \n Warning The Console Can be bad if you dont know what you are doing ")
  }
});
...
Fusion Debugging Console / Dev Console
</div>
